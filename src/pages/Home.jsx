    ...
    <>
      ...
      <header className="inicio-bg">
        <div className="container text-center text-white">
          ...
          <a
            href="#registro"
            className="btn btn-primary btn-lg mt-3 animated fadeIn"
          >
            Más Información
          </a>
        </div>
          ...
          <div className="row text-center">
            <div className="col-md-4 mb-4">
              <div className="info-card animated fadeIn">
                ...
                <p>
                  ...
                  integral de nuestros estudiantes, ofreciendo una educación de
                  calidad y valores sólidos.
                </p>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="info-card animated fadeIn">
                <h4>Misión</h4>
                <p>
                  Nuestra misión es proporcionar una educación de excelencia que
                  fomente el desarrollo académico, personal y social de nuestros
                  estudiantes, preparándolos para ser ciudadanos responsables y
                  comprometidos.
                </p>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="info-card animated fadeIn">
                <h4>Visión</h4>
                <p>
                  Nos esforzamos por ser líderes en la educación, creando un
                  ambiente de aprendizaje innovador y inclusivo, que inspire a
                  nuestros estudiantes a alcanzar su máximo potencial y
